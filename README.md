...
1. **Instalar en Visrtual Box el Sistema Operativo CentOS o Ubuntu (en este caso se utilizó CentOS 7,3 minimal).**(#1)
...
1. **Instalacion de CentOS en Máquina Virtual.**<a name="1"></a>
